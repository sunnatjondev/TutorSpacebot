const ru = {
  ...
  "groupDetail": {
    ...
    "monthlyRate": "Сумма в месяц (UZS)",
    "billingDay": "День списания (1–31)",
    "billingDayHint": "Каждого 1-го числа месяца создаётся счёт для учеников",
    "telegramGroupOptional": "Telegram-группа (опционально)",
    "groupColor": "Цвет группы",
    "weeklySchedule": "Дни занятий в неделю",
    ...
    "exportCSVSub": "Список учеников и история оплат",
    "editGroupSub": "Название, предмет, цена и расписание",
    "manageStudentsSub": "Состав группы и персональные ставки",
