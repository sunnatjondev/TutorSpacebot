const uz = {
  ...
  "groupDetail": {
    ...
    "monthlyRate": "Oylik summa (UZS)",
    "billingDay": "To'lov kuni (1–31)",
    "billingDayHint": "Har oyning ushbu kunida to'lov hisobi yangilanadi",
    "telegramGroupOptional": "Telegram guruh (ixtiyoriy)",
    "groupColor": "Guruh rangi",
    "weeklySchedule": "Haftalik dars jadvali",
    ...
    "exportCSVSub": "O'quvchilar ro'yxati va to'lovlar tarixi",
    "editGroupSub": "Nomi, fani, narxi va dars jadvali",
    "manageStudentsSub": "Guruh tarkibi va shaxsiy stavkalar",
