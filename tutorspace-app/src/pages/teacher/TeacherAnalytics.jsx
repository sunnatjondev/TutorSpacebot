              ...
              return (
                <div key={i} className="flex-1 flex flex-col items-center gap-2 h-full justify-end">
                  <div className="w-full relative h-full flex items-end justify-center">
                    ...
                    {hasExpected && (
                      <div 
                        className="absolute bottom-0 w-full max-w-[24px] bg-[#36343B] rounded-t-full rounded-b-md transition-all duration-300"
                    ...
                    {hasEarned ? (
                      <div 
                        className={`absolute bottom-0 w-full max-w-[24px] ${earnedBarClass} rounded-t-full rounded-b-md transition-all duration-300`}
        ...
        <div className="m3-card">
          ...
          {!topDebtors || topDebtors.length === 0 ? (
            ...
            <div className="space-y-3">
              {topDebtors.map((d, i) => (
                <div key={d.studentId || i} className="flex items-center justify-between p-3.5 rounded-2xl bg-surface-high/60 border border-primary/20 shadow-xs">
